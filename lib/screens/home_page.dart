                  ...
                  Container(
                    ...
                    child: const Text.rich(
                      TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(text: ' Sem 3 starts from 23 rd Dec to 3 rd Jan \n\n', style: TextStyle(fontStyle: FontStyle.italic)),
                          TextSpan(text: ' Kindly submit all your subject realted documents. \n\n', style: TextStyle(fontStyle: FontStyle.italic)),
                          TextSpan(text: ' Submit Your exam forms by 17 th Dec \n\n', style: TextStyle(fontStyle: FontStyle.italic)),
                        ],
                      ),
                    )
                    //child: Text('Today there will be Holiday Due to Diwali');
